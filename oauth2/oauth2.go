...
func GetClient(scope string) *http.Client {
	...
	// If modifying the scope, delete your previously saved credentials at ~/.credentials/youtube-go.json
...
// The web server waits for an oauth code in the three-legged auth flow.
...
// This code originally appeared at: http://stackoverflow.com/questions/10377243/how-can-i-launch-a-process-that-is-not-a-file-in-go
